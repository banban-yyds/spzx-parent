...
@Slf4j
public class CategortDataListener implements ReadListener<CategoryExcelVo> {
    ...
    public CategortDataListener(CategoryMapper categoryMapper) {
    ...
    private void saveData() {
        ...
        categoryMapper.batchAdd(cachedDataList);
        log.info("存储数据库成功！");
    }
}
